...
public class SitBehaviour : StateMachineBehaviour {
	...
	override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
        PlayerInfoManager.Instance.PlayerInfo.IsSitting = true;
    }
    ...
    override public void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex) {
        animator.SetInteger(Animator.StringToHash("ActionType"), 0);
        PlayerInfoManager.Instance.PlayerInfo.IsSitting = false;
    }
